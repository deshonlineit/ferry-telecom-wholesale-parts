...
for (const file of ['i18n.js', 'core.js', 'b2b-ordering.js', 'buyer-currency.js', 'model-search.js', 'discovery-controls.js', 'quick-finder.js', 'category-models.js', 'store.js', 'b2b-catalog.js', 'b2b-menu.js', 'home-landing.js', 'home.js', 'account.js', 'admin-shell.js', 'admin.js', 'admin-products.js', 'admin-prices.js', 'admin-operations.js', 'admin-invoices.js']) {
