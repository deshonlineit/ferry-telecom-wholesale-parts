...
php "$ROOT/bin/reconcile-manufacturer-brands.php"
...
env -i PATH="$PATH" HOME="$HOME" PHP_CLI_SERVER_WORKERS="${PHP_CLI_SERVER_WORKERS:-4}" NATIVE_S2S_SECRET="$BRIDGE_SECRET" \
