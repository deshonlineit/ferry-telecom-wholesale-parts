...
CREATE TABLE IF NOT EXISTS sessions (
 id VARCHAR(128) PRIMARY KEY, data MEDIUMTEXT NOT NULL,
 last_accessed_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
 KEY sessions_last_accessed (last_accessed_at)
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS audit_events (
 ...
 created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
 INDEX audit_events_action_entity_latest (action,entity,entity_id,id DESC)
) ENGINE=InnoDB;
